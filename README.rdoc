...
Before the application has been deployed and after the deploy has been
completed, this helper will post a message to the given Campfire room stating
the username, the application, the branch/tag and the environment. E.g.:

  Scott Woods started deploying myapp v0.5.4 to staging
  ...
